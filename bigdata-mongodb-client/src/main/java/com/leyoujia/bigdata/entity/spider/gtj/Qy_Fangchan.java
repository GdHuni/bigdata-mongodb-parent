 ...
 * @项目版本: 1.1.3
 * @项目名称: 大数据
 * @相对路径: com.jjshome.bigdata.entity.spider.gtj.Qy_Fangchan.java
 * @创建作者: 杨献
 * @问题反馈: yangx@jjshome.com
 * @创建日期: 2017年4月7日 上午8:49:47
 */
public class Qy_Fangchan extends CommonMongo {
	...
	public String get房屋座落() {
		return 房屋座落;
	}
	public void set房屋座落(String 房屋座落) {
		this.房屋座落 = 房屋座落;
	}
	public String get栋号() {
		return 栋号;
	...
	public String get房屋号() {
		return 房屋号;
	}
	public void set房屋号(String 房屋号) {
		this.房屋号 = 房屋号;
	}
