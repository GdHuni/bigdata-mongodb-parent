 ...
 * @项目版本: 1.1.3
 * @项目名称: 大数据
 * @相对路径: com.jjshome.bigdata.entity.spider.gtj.Fs_fangchan.java
 * @创建作者: 杨献
 * @问题反馈: yangx@jjshome.com
 * @创建日期: 2017年4月1日 上午10:49:48
 */
public class Fs_fangchan extends CommonMongo {
	...
	public String get物业管理费() {
		return 物业管理费;
	}
	public void set物业管理费(String 物业管理费) {
		this.物业管理费 = 物业管理费;
	}
	...
	public String get门牌号() {
		return 门牌号;
	}
	public void set门牌号(String 门牌号) {
		this.门牌号 = 门牌号;
	}
	public String get户型() {
		return 户型;
	...
	public String get所属单元() {
		return 所属单元;
	}
	public void set所属单元(String 所属单元) {
		this.所属单元 = 所属单元;
	}
	...
	public String get房屋性质() {
		return 房屋性质;
	}
	public void set房屋性质(String 房屋性质) {
		this.房屋性质 = 房屋性质;
	}
	public String get预测建筑面积() {
		return 预测建筑面积;
	}
	public void set预测建筑面积(String 预测建筑面积) {
		this.预测建筑面积 = 预测建筑面积;
	}
	...
	public String toString() {
		return "Fs_fangchan [项目名称=" + 项目名称 + ", 项目地址=" + 项目地址 + ", 开发商=" + 开发商
				+ ", 物业公司=" + 物业公司 + ", 行政区域=" + 行政区域 + ", 物业管理费=" + 物业管理费
				+ ", 总建筑面积=" + 总建筑面积 + ", 容积率=" + 容积率 + ", 栋阁名称=" + 栋阁名称
				+ ", 楼层=" + 楼层 + ", 房号=" + 房号 + ", 门牌号=" + 门牌号 + ", 户型=" + 户型
				+ ", 所属单元=" + 所属单元 + ", 房屋类型=" + 房屋类型 + ", 规划用途=" + 规划用途
				+ ", 房屋性质=" + 房屋性质 + ", 预测建筑面积=" + 预测建筑面积 + ", 预测套内面积="
				+ 预测套内面积 + "]";
	}
