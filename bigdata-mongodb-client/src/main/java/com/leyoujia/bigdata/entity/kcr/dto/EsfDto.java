...
public class EsfDto implements Serializable{ 
	private Long wsFhId;
	private Long fhId;
	...
	private Integer isSskk;
	private Integer dpDay;
	private Integer isJj;
	private Integer isMgs;
	private Integer isMln;
	private Integer isHbzs;
	private Integer isJs;
	
	
	public Long getWsFhId() {
		return wsFhId;
	}
	public void setWsFhId(Long wsFhId) {
		this.wsFhId = wsFhId;
	}
	public Long getFhId() {
		return fhId;
	...
	public String getComIdiomatic() {
		return comIdiomatic;
	}
	public void setComIdiomatic(String comIdiomatic) {
		this.comIdiomatic = comIdiomatic;
	}
	...
	public Integer getIsSskk() {
		return isSskk;
	}
	public void setIsSskk(Integer isSskk) {
		this.isSskk = isSskk;
	}
	public Integer getDpDay() {
		return dpDay;
	}
	public void setDpDay(Integer dpDay) {
		this.dpDay = dpDay;
	}
	...
	public Integer getIsMgs() {
		return isMgs;
	}
	public void setIsMgs(Integer isMgs) {
		this.isMgs = isMgs;
	}
	public Integer getIsMln() {
		return isMln;
	}
	public void setIsMln(Integer isMln) {
		this.isMln = isMln;
	}
	public Integer getIsHbzs() {
		return isHbzs;
	}
	public void setIsHbzs(Integer isHbzs) {
		this.isHbzs = isHbzs;
	}
