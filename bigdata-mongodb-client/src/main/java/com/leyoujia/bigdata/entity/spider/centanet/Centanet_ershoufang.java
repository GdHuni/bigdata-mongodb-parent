 ...
 * @项目版本: 1.0.0
 * @项目名称: 大数据
 * @相对路径: com.jjshome.bigdata.entity.spider.centanet.Centanet_ershoufang.java
 * @创建作者: 欧阳文斌
 * @问题反馈: ouyangwenbin2009@live.cn
 * @创建日期: 2016年11月26日 下午2:09:29
 */ 
public class Centanet_ershoufang extends CommonMongo {
