 ...
 * @项目版本: 1.0.0
 * @项目名称: 大数据
 * @相对路径: com.jjshome.bigdata.entity.spider.gtj.Jm_Xiaoqu.java
 * @创建作者: 张丽洪
 * @问题反馈: 1248069229@qq.com
 * @创建日期: 2017年2月6日 10:06:57
 */
public class Jm_Xiaoqu extends CommonMongo {

    private String 公安门牌;

    private String 开发商企业;
    ...
    public String get公安门牌() {
        return 公安门牌;
    }

    public void set公安门牌(String 公安门牌) {
        this.公安门牌 = 公安门牌;
    }

    public String get开发商企业() {
        return 开发商企业;
    }

    public void set开发商企业(String 开发商企业) {
        this.开发商企业 = 开发商企业;
    }
    ...
    public String get房屋坐落() {
        return 房屋坐落;
    }

    public void set房屋坐落(String 房屋坐落) {
        this.房屋坐落 = 房屋坐落;
    }
